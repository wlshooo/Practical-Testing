...
class OrderStatisticsServiceTest extends IntegrationTestSupport {
    ...
    @MockBean
    private MailSendClient mailSendClient;  //추가
    ...
    void sendOrderStatisticsMail() {
        //given
        LocalDateTime now = LocalDateTime.of(2024, 3, 3, 0, 0);
        ...
        Order order1 = createPaymentCompletedOrder(products, LocalDateTime.of(2024, 3, 2, 23, 59,59));
        Order order2 = createPaymentCompletedOrder(products, now);
        Order order3 = createPaymentCompletedOrder(products, LocalDateTime.of(2024, 3, 3, 23, 59, 59));
        Order order4 = createPaymentCompletedOrder(products, LocalDateTime.of(2024, 3, 4, 0, 0));
        ...
        boolean result = orderStatisticsService.sendOrderStatisticsMail(
                LocalDate.of(2024, 3, 3), "test@test.com");
